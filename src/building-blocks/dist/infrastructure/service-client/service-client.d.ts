...
export interface ServiceClient {
    ...
    subscribe<PayloadType extends object = {}, Response extends object | void = void>(topic: string, callback: (data: PayloadType, context: ServiceClientSubscriberContext) => Response): Promise<void>;
}
